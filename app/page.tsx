  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] text-zinc-900 selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 bg-white/85 backdrop-blur-md border-b border-zinc-200/80">
        <div className="mx-auto flex h-14 sm:h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              href="/auth"
              className="text-xs font-semibold text-zinc-600 hover:text-zinc-900 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg transition"
            >
              Sign In
            </Link>
            <Link
              href="/auth"
              className="inline-flex items-center gap-1 sm:gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-500 shadow-xs transition active:scale-[0.99]"
            >
              Get Started
      ...
      <section className="relative pt-12 pb-16 sm:pt-24 sm:pb-28 px-4 sm:px-6 max-w-5xl mx-auto text-center">
        ...
        >
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-[11px] sm:text-xs font-semibold text-indigo-700">
            <Sparkles className="h-3.5 w-3.5" />
            <span>Open Source Learning Operating System</span>
          </div>

          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-zinc-900 max-w-3xl mx-auto leading-[1.15] sm:leading-[1.1]">
        ...
        <motion.div
          ...
          className="mt-10 sm:mt-14 p-1.5 sm:p-3 rounded-2xl bg-zinc-100 border border-zinc-200/80 shadow-md max-w-3xl mx-auto text-left"
        >
          <div className="rounded-xl bg-white border border-zinc-200 p-4 sm:p-8 space-y-4 sm:space-y-6">
            <div className="flex items-center justify-between border-b border-zinc-100 pb-3 sm:pb-4 gap-2">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-lg bg-indigo-50 flex items-center justify-center text-indigo-600 flex-shrink-0">
                  <Brain className="h-4 w-4" />
                </div>
                <div className="min-w-0">
                  <h3 className="text-xs sm:text-sm font-bold text-zinc-900 truncate">System Design & Next.js Mastery</h3>
                  <p className="text-[10px] sm:text-xs text-zinc-400">Daily Spaced Review • Card 4 of 12</p>
                </div>
              </div>
              <span className="text-[10px] sm:text-xs font-semibold px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 flex-shrink-0">
                14 Day Streak
              </span>
            </div>

            <div className="p-4 sm:p-6 rounded-xl bg-zinc-50 border border-zinc-200/60 space-y-1.5 sm:space-y-2">
              <span className="text-[10px] sm:text-[11px] font-bold text-indigo-600 uppercase tracking-wider">Concept Flashcard</span>
              <p className="text-sm sm:text-lg font-semibold text-zinc-900 break-words">
                What is the primary benefit of the SuperMemo-2 (SM-2) spaced repetition algorithm?
              </p>
              <p className="text-xs sm:text-sm text-zinc-500 pt-0.5 sm:pt-1">
                → It dynamically scales review intervals based on recall difficulty, maximizing long-term retention.
              </p>
            </div>
      ...
      {/* Feature Grid */}
      <section className="py-12 sm:py-24 bg-zinc-50 border-t border-zinc-200/80 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12">
          <div className="text-center max-w-xl mx-auto space-y-2 sm:space-y-3">
            <h2 className="text-xl sm:text-3xl font-bold tracking-tight text-zinc-900">
          ...
          <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="p-4 sm:p-6 rounded-2xl bg-white border border-zinc-200/80 shadow-xs hover:border-indigo-300 transition"
                >
                  <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-3 sm:mb-4">
                    <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                  </div>
                  <h3 className="font-bold text-sm sm:text-base text-zinc-900 mb-1">{feature.title}</h3>
      ...
      {/* Footer */}
      <footer className="py-6 sm:py-8 border-t border-zinc-200 px-4 sm:px-6 text-center text-xs text-zinc-400">
