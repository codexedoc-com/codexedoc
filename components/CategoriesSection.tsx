    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          ...
          <h3 className="mt-1 text-lg sm:text-2xl font-black">Categories</h3>
        </div>
        {onCreateCategory && (
          <button
        ...
        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((category, index) => (
            <motion.div
              ...
              className="group rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-xl hover:border-indigo-500/30 hover:bg-white/8 cursor-pointer transition transform hover:scale-105"
            >
