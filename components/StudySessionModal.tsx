...
export function StudySessionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-xs p-4">
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-zinc-200 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Top Bar */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-lg bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 font-semibold text-xs">
          ...
          {loading ? (
            ...
            <div className="py-6 space-y-6">
              <div className="text-center">
                <div className="mx-auto h-14 w-14 rounded-2xl bg-indigo-50 border border-indigo-100 text-indigo-600 flex items-center justify-center mb-3">
                  <Sparkles className="h-7 w-7" />
                </div>
                <h3 className="text-2xl font-bold text-zinc-900">Session Complete!</h3>
              ...
              <div className="grid grid-cols-2 gap-3 max-w-md mx-auto">
                <div className="p-4 rounded-xl border border-zinc-100 bg-zinc-50/50 text-center">
                  <p className="text-xs font-medium text-zinc-500">Cards Reviewed</p>
                  <p className="text-2xl font-bold text-zinc-900 mt-1">{reviewedCount}</p>
                </div>
                <div className="p-4 rounded-xl border border-zinc-100 bg-zinc-50/50 text-center">
                  <p className="text-xs font-medium text-zinc-500">Time Studied</p>
                  <p className="text-2xl font-bold text-zinc-900 mt-1">{formatTime(elapsedSeconds)}</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div
                ...
                className={`group relative min-h-[260px] p-8 rounded-2xl border transition-all duration-200 cursor-pointer flex flex-col justify-between select-none ${
                  isFlipped
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-semibold px-2.5 py-1 rounded-md bg-zinc-100 text-zinc-600">
                ...
                <div className="pt-6 mt-4 border-t border-zinc-100 flex items-center justify-between text-xs text-zinc-400">
                  <span className="flex items-center gap-1">
                    <RotateCw className="h-3.5 w-3.5" />
                    Click or press Spacebar to {isFlipped ? "hide answer" : "reveal answer"}
                  </span>
              ...
              {isFlipped ? (
                <div className="space-y-2">
                  <p className="text-xs text-center font-medium text-zinc-500">
                    How well did you remember this? (Press 1 - 4)
                  </p>
                  <div className="grid grid-cols-4 gap-2">
                    <button
                      onClick={() => handleRate(1)}
                      className="p-3 rounded-xl border border-rose-200 bg-rose-50 text-rose-800 hover:bg-rose-100 font-semibold text-xs transition text-center cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="p-3 rounded-xl border border-amber-200 bg-amber-50 text-amber-800 hover:bg-amber-100 font-semibold text-xs transition text-center cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="p-3 rounded-xl border border-indigo-200 bg-indigo-50 text-indigo-800 hover:bg-indigo-100 font-semibold text-xs transition text-center cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="p-3 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-800 hover:bg-emerald-100 font-semibold text-xs transition text-center cursor-pointer"
                    >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-zinc-900 text-white font-semibold text-sm hover:bg-zinc-800 transition cursor-pointer"
                >
                  Show Answer (Space)
                </button>
              )}
